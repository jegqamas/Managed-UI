...
namespace ManagedUI
{
    ...
    {
        private static FormManagedMesssageBox frm;
        ...
        /// <returns><see cref="ManagedMessageBoxResult"/> object includes which button clicked and the check box result.</returns>
            ...
            bool checkBoxValue, string checkBoxText, bool RightToLeft)
        {
            ...
            frm = new FormManagedMesssageBox();
